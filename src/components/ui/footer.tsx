        ...
        >
          ...
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-sm text-gray-600">
              Mission Pointers helps VCFSE organisations plan, fund, and deliver with confidence through practical strategy, sector‑savvy funding support, and modern digital tools.
              <br />
              <br /> {/* Add this line for an empty space */}
